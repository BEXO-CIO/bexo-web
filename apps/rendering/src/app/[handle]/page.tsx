...
/**
 * Generate SEO metadata dynamically based on user profile info.
 */
...
/**
 * Subdomain-based portfolio page — middleware rewrites kavin.mybexo.com → /kavin
 * which resolves to this [handle] dynamic segment.
 */
